...
public class Principal {
	public static void main(String args[]) {
		...
		System.out.print("Regras: O 1° Jogador criado será o 1° a jogar e sua letra será a X.\n");
		System.out.print("Regras: Jogue com letras maiúsculas.\n\n");
		...
		do {
			...
			System.out.println("\nLembre-se de jogar com letras maiúsculas!\n");
			JogoDaVelha game = new JogoDaVelha(size);
			for(int i=0;i<size*size;i++) {
				System.out.println(game.toString());
				game.diminuiJogadas();
				if(i%2 == 0)
					System.out.println("---É a vez da letra X !");
				else
